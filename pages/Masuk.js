import { Image, StyleSheet, Dimensions, RefreshControl, TouchableOpacity, PermissionsAndroid, Text, View, Alert, TouchableOpacityBase, ScrollView } from 'react-native'
        ...
        fetch('https://afanalfiandi.com/attendly/api/api.php?op=getJam', {
            ...
            .then((responseJson) => {
                if (responseJson.masuk != null && responseJson.pulang != null) {
                    setJam(responseJson.masuk);
                    setJamPulang(responseJson.pulang);
                } else if (responseJson.pulang != null) {
                    setJamPulang(responseJson.pulang);
                }
            }).catch((e) => {
                console.log(e);
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View elevation={3} style={styles.content}>
                    <Text style={styles.headerText}>Presensi Masuk</Text>
